          ...
          <div class="col-md-12">
            ...
            <div class="collapse navbar-collapse navbar-right" id="myNavbar">
              <ul class="nav navbar-nav">
                ...
                <li><a href="#doctor-team">À propos</a></li>
      ...
      <div class="container">
        <div class="row">
          <div class="banner-info text-center">
            ...
            <h3 style="color: antiquewhite;"><b>Écouter</b>, <b>Préserver</b>, <b>Soigner</b></h3>
      ...
      <div class="row">
        ...
        <div class="col-md-4 col-sm-4">
          <div class="service-info">
            ...
            <div class="icon-info"><h4>Diagnostic médical</h4></div>
          </div>
          <div class="service-info">
            <div class="icon"><i class="fa fa-ambulance"></i></div>
            <div class="icon-info"><h4>Services d'urgence</h4></div>
          </div>
        </div>
        <div class="col-md-4 col-sm-4">
          <div class="service-info">
            <div class="icon"><i class="fa fa-user-md"></i></div>
            <div class="icon-info"><h4>Conseil médical</h4></div>
          </div>
          <div class="service-info">
            <div class="icon"><i class="fa fa-medkit"></i></div>
            <div class="icon-info"><h4>Suivi médical</h4></div>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-3 col-xs-6">
          <div class="thumbnail">
            ...
            <div class="caption">
              <h3>MAHFOUD YASSMINE</h3>
              <p><b>Médecin généraliste</b></p>
              <p>Tél: 078981314<br>Email: mahfoud@hotmail.com</p>
        ...
        <div class="col-md-3 col-sm-3 col-xs-6">
          <div class="thumbnail">
            ...
            <div class="caption">
              ...
              <p>Tél: 0615142526<br>Email: wissale@hotmail.com</p>
              <ul class="list-inline">
                <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                <li><a href="#"><i class="fa fa-google-plus"></i></a></li>
        ...
        <div class="col-md-3 col-sm-3 col-xs-6">
          <div class="thumbnail">
            ...
            <div class="caption">
              <h3>BARMAKI</h3>
              <p><b>Secrétaire</b></p>
              <p>Tél: 0615142526<br>Email: barmaki@hotmail.com</p>
              <ul class="list-inline">
                <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                <li><a href="#"><i class="fa fa-google-plus"></i></a></li>
